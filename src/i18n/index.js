    ...
    translation: {
      common: {
        ...
        walletErrors: {
          ...
          walletTimeout: "钱包响应超时，请回到钱包确认或重新连接",
        ...
        dappSignature: {
          title: "签名进入 DApp",
          desc: "为确认当前钱包归属，请先完成一次钱包签名。签名不会产生链上交易或手续费。",
          action: "签名进入",
          signing: "签名中...",
          success: "签名成功",
          failed: "签名失败，请重试",
    ...
    translation: {
      common: {
        ...
        walletErrors: {
          ...
          walletTimeout: "Wallet response timed out. Confirm in your wallet or reconnect.",
        ...
        dappSignature: {
          title: "Sign to Enter DApp",
          desc: "Please sign once to confirm wallet ownership. This signature does not create an on-chain transaction or gas fee.",
          action: "Sign to Enter",
          signing: "Signing...",
          success: "Signature confirmed",
          failed: "Signature failed. Please try again.",
        },
      },
      nav: {
        home: "Home",
      ...
      landing: {
        ...
        hero: {
          ...
          titlePrefix: "Connecting Traditional Payments with the",
          titleWeb3: "Web3",
          titleSuffix: "Future.",
  ...
  translation: mergeTranslations(resources.zh.translation, {
    common: {
      ...
      walletErrors: {
        ...
        walletTimeout: "錢包響應逾時，請回到錢包確認或重新連接",
      ...
      dappSignature: {
        title: "簽名進入 DApp",
        desc: "為確認目前錢包歸屬，請先完成一次錢包簽名。簽名不會產生鏈上交易或手續費。",
        action: "簽名進入",
        signing: "簽名中...",
        success: "簽名成功",
        failed: "簽名失敗，請重試",
  ...
  translation: mergeTranslations(resources.en.translation, {
    common: {
      ...
      walletErrors: {
        ...
        walletTimeout: "ウォレットの応答がタイムアウトしました。ウォレットで確認するか再接続してください。",
      ...
      dappSignature: {
        title: "署名してDAppへ入る",
        desc: "ウォレット所有者確認のため、一度署名してください。オンチェーン取引やGas手数料は発生しません。",
        action: "署名して入る",
        signing: "署名中...",
        success: "署名が完了しました",
        failed: "署名に失敗しました。再試行してください。",
      },
    },
    nav: {
      home: "ホーム",
  ...
  translation: mergeTranslations(resources.en.translation, {
    common: {
      ...
      walletErrors: {
        ...
        walletTimeout: "지갑 응답 시간이 초과되었습니다. 지갑에서 확인하거나 다시 연결하세요.",
      ...
      dappSignature: {
        title: "서명 후 DApp 입장",
        desc: "현재 지갑 소유 확인을 위해 지갑 서명을 완료해 주세요. 서명은 온체인 거래나 Gas 수수료를 발생시키지 않습니다.",
        action: "서명하고 입장",
        signing: "서명 중...",
        success: "서명 완료",
        failed: "서명 실패. 다시 시도하세요.",
      },
    },
    nav: {
      home: "홈",
      mining: "마이닝",
      c2cUnavailable: "아직 오픈되지 않았습니다",
      seed: "시드 NETE",
      team: "팀",
      my: "내 계정",
      wallet: {
